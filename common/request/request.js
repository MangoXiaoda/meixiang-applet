...
class Request {
  constructor(config = {}) {
	...
	this.RequestApiUrl = null;
	this.RequestApiMethod = null;
  ...
  _request(method, url, config) {
	...
	this.RequestOption  = lastConfig.data? lastConfig.data: {};
      ...
      uni.request({
        ...
        async complete(response) {
          ...
          if (_this.resInterceptors && typeof _this.resInterceptors === 'function') {
			...
			_this.RequestApiUrl = url;
			_this.RequestApiMethod = method;
			_this.RequestOption  = lastConfig.data? lastConfig.data: {};
